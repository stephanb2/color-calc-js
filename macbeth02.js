...
SB = {
    "data":{"CIEobs31":{}, "CIEil":{}, "GMCCavg30":{}, "CCdisplay":{} }
};
...
SB.macbeth = (function ($) {
    ...
    function showResults(CC_Id) {
        ...
        var XYZ = specToXYZ(SB.data.GMCCavg30, CC_Id, illumRef, "CIEobs31"); 
